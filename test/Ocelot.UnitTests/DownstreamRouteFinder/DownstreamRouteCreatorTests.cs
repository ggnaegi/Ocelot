...
namespace Ocelot.UnitTests.DownstreamRouteFinder
{
    public class DownstreamRouteCreatorTests
    {
        ...
        {
            var configuration = new InternalConfiguration(null, "doesnt matter", null, "doesnt matter", _loadBalancerOptions, "http", _qoSOptions, _handlerOptions, new Version("1.1"), HttpVersionPolicy.RequestVersionOrLower);
        ...
        public void should_create_downstream_route_with_rate_limit_options()
        {
            ...
            var configuration = new InternalConfiguration(routes, "doesnt matter", null, "doesnt matter", _loadBalancerOptions, "http", _qoSOptions, _handlerOptions, new Version("1.1"), HttpVersionPolicy.RequestVersionOrLower);
        ...
        public void should_create_downstream_route_with_segments_no_traling_slash()
        {
            ...
            var configuration = new InternalConfiguration(null, "doesnt matter", null, "doesnt matter", _loadBalancerOptions, "http", _qoSOptions, _handlerOptions, new Version("1.1"), HttpVersionPolicy.RequestVersionOrHigher);
        ...
        public void should_create_downstream_route_for_sticky_sessions()
        {
            ...
            var configuration = new InternalConfiguration(null, "doesnt matter", null, "doesnt matter", loadBalancerOptions, "http", _qoSOptions, _handlerOptions, new Version("1.1"), HttpVersionPolicy.RequestVersionOrLower);
        ...
        public void should_create_downstream_route_with_qos()
        {
            ...
            var configuration = new InternalConfiguration(null, "doesnt matter", null, "doesnt matter", _loadBalancerOptions, "http", qoSOptions, _handlerOptions, new Version("1.1"), HttpVersionPolicy.RequestVersionOrLower);
